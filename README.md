...
4. Перейдите в директорию с ботом. Создайте там текстовый файл с именем "**.env**", куда сохраните полученный от @BotFather токен вашего бота (для примера возьмём значение API Token: ``1234567890:AbcDefGhiJklMnoPqrStuVwxYz``)  
