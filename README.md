...
Телеграм-бот написан на основе библиотеки [aiogram v.3](https://docs.aiogram.dev/) - в этой библиотеке реализовано взаимодействие с [Telegram Bot API](https://core.telegram.org/bots/api)  
...
2. Скачайте все файлы [iin_find_bot](https://github.com/mvgolubev/iin_find_bot/) из репозитория GitHub.
   ...
   **б)** Если вы НЕ используете **Git**, тогда можно скачать все файлы с сайта GitHub в виде одного ZIP-файла (с последующей распаковкой файлов проекта):  
      ...
      ![github_download](https://github.com/user-attachments/assets/037ea72a-3cf7-4c57-a888-d535ad8e55f9)
...
6. В виртуальное окружение установите зависимости из файла `requirements.txt`:  
