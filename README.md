...
**bot.py** — телеграм-бот на основе библиотеки [aiogram v.3](https://docs.aiogram.dev/) - в этой библиотеке реализовано взаимодействие с [Telegram Bot API](https://core.telegram.org/bots/api)  
